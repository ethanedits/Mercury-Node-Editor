...
class VarNode(Node):
    ...
    def __init__(self, scene, inputs=[2,2], outputs=[]):
        super().__init__(scene, self.__class__.op_title, inputs, outputs)
...
class CalcNode4(Node):
    ...
    def __init__(self, scene, inputs=[2,2,2,2], outputs=[1]):
        super().__init__(scene, self.__class__.op_title, inputs, outputs)
    ...
    def evalImplementation(self):
        ...
        if i1 is None or i2 is None or i3 is None or i4 is None:
            ...
            val = self.evalOperation(i1.eval(), i2.eval(), i3.eval(), i4.eval())
            self.value = val
            self.markDirty(False)
            self.markInvalid(False)
            self.grNode.setToolTip("")
...
class CalcNode5(Node):
    ...
    def __init__(self, scene, inputs=[2,2,2,2,2], outputs=[1]):
        super().__init__(scene, self.__class__.op_title, inputs, outputs)
    ...
    def evalImplementation(self):
        ...
        if i1 is None or i2 is None or i3 is None or i4 is None or i5 is None:
            self.markInvalid()
            self.markDescendantsDirty()
            self.grNode.setToolTip("Connect all inputs")
            return None
            ...
            val = self.evalOperation(i1.eval(), i2.eval(), i3.eval(), i4.eval(), i5.eval())
            self.value = val
            self.markDirty(False)
            self.markInvalid(False)
            self.grNode.setToolTip("")
